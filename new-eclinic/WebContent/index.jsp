...
<center>
<%if(session.getAttribute("usernamedoc")==null) 
	{%>
<a href="signindoc.jsp">
	...
	<i class="fa fa-user-md fa-5x" style="color:black"></i>
      <h4 style="color:black">Doctor profile</h4></a>
     <% }%> 
	  </center>
    </div>
...
<div class="col-sm-4">
	    ...
	    {%>
	     <a href="signinpatient.jsp"> <i class="fa fa-user fa-5x" style="color:black"></i>
          ...
          <%}else{ %>
           <a href="patientprofile.jsp"> <i class="fa fa-user fa-5x" style="color:black"></i>
            <h4 style="color:black">Patient Profile</h4></a>
          <%} %>
	  </center>
    </div>
<div class="col-sm-4">
